...
#if defined(CONFIG_TOUCHSCREEN_NT36xxx) || defined(CONFIG_TOUCHSCREEN_SYNAPTICS_DSX_v27) || defined(CONFIG_TOUCHSCREEN_SYNAPTICS_DSX) || defined(CONFIG_TOUCHSCREEN_HIMAX_CHIPSET)
...
#define KEY_TP_GESTURE_DOUBLE_CLICK 	759
#endif
#endif
